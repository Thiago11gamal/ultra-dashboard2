        ...
        <div className={`fixed z-[100]
            ...
            >
                {collapsed ? (
                    ...
                    <div className="flex items-center gap-2 md:gap-3 w-full overflow-x-auto lg:overflow-visible [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] mobile-edge-fade pb-1 -mb-1 px-1">
                        {/* Brand Logo */}
