...
export default function Sidebar({ onExport, onImport, collapsed, setCollapsed, user, isMobile, onOpenHelp }) {
    ...
    return (
        <div className={`fixed z-[100]
            ...
            md:top-8 md:left-1/2 md:-ml-7 md:w-auto md:bg-transparent md:bg-none md:backdrop-blur-none md:border-none md:shadow-none md:px-0 md:py-0
            ${isVisible
                ? 'translate-y-0 opacity-100 transition-[transform,opacity] duration-150 ease-out md:top-8'
            ...
            <div
                className={`
                    ...
                    ${collapsed
                        ...
                        : 'glass-panel w-auto px-4 py-3.5 rounded-2xl'}
                `}
                onClick={(e) => {
                    if (collapsed) {
                        e.stopPropagation();
