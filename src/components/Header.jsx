    ...
    return (
        <>
            ...
            <header className="hidden lg:flex items-center justify-center py-1 px-4 fixed top-0 left-0 right-0 lg:left-[var(--sidebar-width,0)] z-[110] backdrop-blur-xl bg-[#0a0f1e]/85 border-b border-white/[0.05] min-h-[48px] transition-all duration-300">
                <div className="w-full max-w-[1500px] flex items-center justify-between gap-4">
                    {/* Desktop Toggle Button */}
                    <button
                        onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
                        className="p-1.5 rounded-xl bg-white/[0.03] border border-white/[0.05] text-slate-400 hover:text-white hover:bg-white/[0.08] transition-all"
                    ...
                    {/* ─── CENTRAL USER NAME ─── */}
                    <div className="flex flex-col items-center group pointer-events-auto z-20 mt-0.5">
                    ...
                    <div className="flex items-center gap-3 flex-1 justify-end">
                        <button
                            onClick={onUndo}
                            className="p-1.5 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.08] transition-all text-slate-500 hover:text-white group relative"
                        >
                            <RotateCcw size={16} />
                        ...
                        <div className="h-8 w-[1px] bg-white/[0.05] mx-1" />
