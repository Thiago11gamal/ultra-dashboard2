            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                    ...
                    <Motion.div
                        ...
                        className="bg-slate-900/80 border border-white/10 backdrop-blur-2xl rounded-[2.5rem] w-full max-w-md shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col focus:outline-none"
                    >
                        <div
                            className="absolute -top-24 -right-24 w-48 h-48 bg-purple-500/20 rounded-full blur-[80px] pointer-events-none animate-pulse"
                            aria-hidden="true"
                        />

                        <div
                            className="absolute -bottom-24 -left-24 w-48 h-48 bg-blue-500/20 rounded-full blur-[80px] pointer-events-none animate-pulse"
                        ...
                        <div className="p-8 sm:p-10 relative z-10">
                            <div className="flex items-center gap-3 mb-6">
                                <div
                                    className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center shadow-lg shadow-purple-500/20"
                                    aria-hidden="true"
                                >
                                    {isDisciplina ? (
                                ...
                                <div>
                                    <h2
                                        id={titleId}
                                        className="text-2xl font-black text-white tracking-tight leading-none mb-1"
                                    >
                                        {safeTitle}
                                    </h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div
                                            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gradient-to-r from-purple-500 to-blue-500 group-focus-within:w-1/2 transition-all duration-500"
                                            aria-hidden="true"
                                        />
                                    </div>
                                </div>
                        ...
                        <div
                            className="h-1.5 w-full bg-gradient-to-r from-purple-600 via-blue-500 to-emerald-500 opacity-50"
                            aria-hidden="true"
                        />
                    </Motion.div>
                </div>
