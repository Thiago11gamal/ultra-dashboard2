...
const ACHIEVEMENTS = [
    ...
    { id: 'streak_3', name: 'Iniciante Consistente', description: 'Mantenha um streak de 3 dias', icon: '🔥', xpReward: 150 },
    { id: 'streak_7', name: 'Semana Invicta', description: 'Mantenha um streak de 7 dias', icon: '🏆', xpReward: 350 },
    { id: 'streak_30', name: 'Maratonista', description: 'Mantenha um streak de 30 dias', icon: '👑', xpReward: 1000 },
    { id: 'centurion', name: 'Centurião', description: 'Responda 100 questões', icon: '💯', xpReward: 300 },
    { id: 'perfectionist', name: 'Perfeccionista', description: 'Acerte 100% em um simulado', icon: '🎯', xpReward: 500 },
    { id: 'pomodoro_10', name: 'Focado', description: 'Complete 10 Pomodoros', icon: '⏱️', xpReward: 300 },
    { id: 'early_bird', name: 'Madrugador', description: 'Estude antes das 7h da manhã', icon: '🌅', xpReward: 200 },
    { id: 'night_owl', name: 'Coruja', description: 'Estude após meia-noite', icon: '🦉', xpReward: 200 },
];
...
export const XPHistory = ({ user }) => {
    ...
    return (
        <div className="rounded-xl p-4 border border-white/10 bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm">
            ...
            <div className="text-center">
                <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">{xp.toLocaleString()}</div>
            </div>
        </div>
    );
};
