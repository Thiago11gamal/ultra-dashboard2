...
export function DisciplinaCard({ cat, level, target, isFocused, onClick, unit = '%', maxScore = 100 }) {
    ...
    return (
        <button onClick={onClick}
            className={`relative text-left w-full rounded-none border p-3 sm:p-4 transition-all duration-500 group min-h-[82px] sm:min-h-[105px] overflow-hidden ${isFocused ? 'shadow-[0_0_30px_-5px_rgba(0,0,0,0.6)] z-20 border-transparent bg-white/[0.03]' : 'border-slate-800/40 hover:border-slate-700/60 hover:bg-slate-800/30 active:scale-95'}`}
            style={{
