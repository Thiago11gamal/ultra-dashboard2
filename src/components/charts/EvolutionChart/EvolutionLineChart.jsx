...
export function EvolutionLineChart({
    ...
    const yAdjustedMap = React.useMemo(() => {
        ...
        const MIN_PCT_DISTANCE = 7.5;

        // 🎯 SCALE BUG FIX: Se o espaço total não for suficiente para a separação obrigatória,
        // a distância deve ser achatada dinamicamente para caber na tela.
        const maxAvailableSpace = maxScore * 0.96;
        ...
        // 🎯 SAFETY CLAMP: Garante que nenhum label saia dos limites visíveis
    ...
    return (
        <div className="h-[250px] sm:h-[450px] md:h-[650px] w-full outline-none focus:outline-none focus:ring-0">
            <ResponsiveContainer width="100%" height="100%" className="outline-none focus:outline-none focus:ring-0">
                ...
                <ComposedChart data={enhancedChartData} margin={{ top: 20, right: 85, left: 0, bottom: 20 }} style={{ outline: 'none' }} tabIndex="-1">
                    <defs>
