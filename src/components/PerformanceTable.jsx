                                    ...
                                    <td className="p-5 border-r border-white/5">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col min-w-0">
                                                <span className="font-bold text-sm truncate uppercase tracking-tight max-w-[120px] sm:max-w-[180px] md:max-w-[250px] min-w-0 block pb-0.5" style={{ color: category.color }}>
                                                    {category.name}
                                                </span>
