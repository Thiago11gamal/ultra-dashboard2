...
const StatsCards = ({ data, onUpdateGoalDate }) => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 auto-rows-auto gap-3 sm:gap-4 animate-fade-in-down">
            {/* ── Sequência ─────────────────────────────────────────────────── */}
            <div className="relative glass-hover bg-[#151720]/95 border border-white/10 rounded-2xl p-6 flex flex-col justify-between group transition-all duration-500 shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col h-full">
                    <div
                        className="flex items-center gap-2 sm:gap-3 mb-2 relative group/tooltip cursor-help focus-visible:outline-none rounded-lg"
                        tabIndex={0}
                    >
            ...
            {/* ── Data da Prova ───────────────────────────────────────────── */}
            <div className={`relative bg-[#151720]/95 border rounded-2xl p-6 transition-all duration-700 flex flex-col items-center justify-between h-full group shadow-2xl ${!user.goalDate
                ? 'border-slate-500/30'
                ...
                {/* Date picker */}
                <div
                    className="relative z-10 w-full flex flex-col items-center justify-center group/rightside cursor-pointer py-2"
                ...
                >
                    ...
                    <div className="flex flex-col items-center gap-2 mb-3 pointer-events-none">
                        ...
                        <span className={`text-xs font-black uppercase tracking-widest text-center leading-normal transition-colors ${!user.goalDate
                            ? 'text-slate-500'
                    ...
                    <div className="relative group/input flex justify-center w-full pointer-events-none">
                        <div className={`w-[120px] bg-slate-900/50 border rounded-lg py-1.5 text-sm font-bold transition-all group-hover/rightside:bg-slate-800 group-hover/rightside:text-white group-hover/rightside:border-white/20 text-center leading-relaxed ${!user.goalDate
