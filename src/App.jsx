          ...
          {!isPremium ? (
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-[auto_1fr] w-full h-dvh overflow-hidden animate-page-entrance">
              ...
              <div className="flex flex-col h-dvh w-full min-w-0 relative">
                ...
                <main className="flex-1 w-full max-w-[1500px] mx-auto px-4 sm:px-8 lg:px-10 mt-0 pt-[110px] lg:pt-0 pb-24 lg:pb-12 overflow-y-auto overflow-x-hidden custom-scrollbar relative z-0">
                  <Motion.div 
                    key={activeContestId}
