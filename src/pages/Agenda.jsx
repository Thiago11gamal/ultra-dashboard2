...
export default function Agenda() {
  const agenda = useAppStore(state => getActiveContest(state).agenda || EMPTY_ARRAY);
  const categories = useAppStore(state => getActiveContest(state).categories || EMPTY_ARRAY);
